...
//   },
  {
    'name': 'desktop-2500-1600',
    'viewport': {width: 2500, height: 1600}
  },
...
var date;
date = new Date();
screenshotDateTime = date.getUTCFullYear() + '-' +
...
pathArray = screenshotUrl.split('/')
pathToSave = 'screenshots/'+pathArray[2]+'/'+pathArray.slice(3).join('_')
...
casper.each(viewports, function(casper, viewport) {
  ...
  this.then(function(){
    ...
    this.capture(pathToSave +'/'+ screenshotDateTime + '/' + viewport.name + '-' + viewport.viewport.width + 'x' + viewport.viewport.height + '.png', {
        top: 0,
        left: 0,
